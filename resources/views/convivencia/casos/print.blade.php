...
<head>
    ...
    <style>
         ...
         * - Margen superior: 3.5cm (espacio para encabezado fijo)
         * - Margen inferior: 2.5cm (espacio para pie de página fijo)
         * - Margen izquierdo: 2.0 cm (según directrices)
         * - Encabezado y pie se repiten automáticamente en cada página
         */
...
<body>
    ...
    <!-- Encabezado fijo (se repite automáticamente en cada página) -->
    ...
    <!-- Pie de página fijo (se repite automáticamente con numeración) -->
        ...
        <div class="footer-content">
            <script type="text/php">
                if (isset($pdf)) {
                    ...
                    $pdf->page_text(275, 815, $pageText, $font, $size, array(0.4, 0.4, 0.4));
                }
            </script>
        </div>
    </div>

    <!-- Contenido principal (fluye dinámicamente según datos) -->
